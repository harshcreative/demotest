...
orangePlaneImg.src = '/tm360/images/form/plan.png'; // Replace with actual path
const whitePlaneImg = new Image();
whitePlaneImg.src = '/tm360/images/form/plan.png'; // Replace with actual path
const greenPlaneImg = new Image();
greenPlaneImg.src = '/tm360/images/form/plan.png'; // Replace with actual path

// Load Ashoka Chakra image as HTML img element
const chakraImg = new Image();
chakraImg.src = '/tm360/images/form/ashoka-chakra.png'; // Replace with actual path
...
function updatePosition(plane) {
    ...
    if (
        ...
        playAudio('/tm360/images/form/super_sonic_boom.mp3', 0.02, 2); // Adjust volume and speed accordingly
    }
