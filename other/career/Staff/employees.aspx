<%@ Page Language="C#" AutoEventWireup="true" codefile="employees.aspx.cs" Inherits="employeesjson" %>
    ...
    <head>
        ...
        <meta property="og:description" content="TaxManager Employee Deatils">
        ...
        <meta name="twitter:description" content="TaxManager Employee Deatils">
        ...
        <meta name="description" content="TaxManager Employee Deatils">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
                <div class="container-fluid pe-0">
                    <a aria-label="Twitter" class="navbar-brand" href="https://www.TaxManager.in">
                        <img src="https://www.TaxManager.in/newsite/images/logo.png" alt="taxmanager in logo"></a>
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                        ...
                        <div class="login-sign-up-sm">
                            <div class="login1">
                                <i class="fa fa-lock" aria-hidden="true"></i>&nbsp;<a aria-label="Twitter"
                                    href="https://www.TaxManager.in/Login/Login.aspx">login</a>
                            </div>
                            <div class="signup1">
                                <i class="fa fa-user" aria-hidden="true"></i>&nbsp;<a aria-label="Twitter"
                                    href="https://www.TaxManager.in/Login/Login.aspx">Register</a>
                            </div>
                        </div>
                        <div>
                    ...
                    Investments">
                        ...
                        show-Investments">
                                    ...
                                    Fund" style="margin-top: 6px;">&nbsp;Public
                                                        Provident Fund</a></li>
                                                <li><a aria-label="Twitter" class="dropdown-item"
                                    ...
                                    Certificates" style="margin-top: -6px;">&nbsp;National
                                ...
                                <li class="nav-item dropdown blue-hover">
                                    ...
                                    <ul class="animate slideIn sub-menue-sub" aria-labelledby="navbarDropdownMenuLink"
                                        ...
                                        <li><a aria-label="Twitter" class="dropdown-item"
                                                ...
                                                your Startup</a></li>
                                        <li><a aria-label="Twitter" class="dropdown-item"
                                                href="https://www.taxmanager.in/manageyourStartup">Manage your
                                                Startup</a></li>
                                        <li><a aria-label="Twitter" class="dropdown-item"
                                                href="https://www.taxmanager.in/growyourStartup">Grow your Startup</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item blue-hover">
                                ...
                                <div class="login-sign-up-sm sm-contact">
                                    <div class="login1">
                                        <i class="fa fa-mobile" aria-hidden="true"></i>&nbsp;<a aria-label="Twitter"
                                            href="tel:+919555331122"> +919555331122</a>
                                    </div>
                                    <div class="signup1">
                        ...
                        <ul class="navbar-nav NavArea">
                            ...
                            <li class="nav-item dropdown blue-hover">
                                <a aria-label="Twitter" class="nav-link dropdown-toggle"
                                    href="https://www.taxmanager.in/individuals/index">Individuals <i
                    ...
                    dropdown-toggle">
                                ...
                                <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <li class="dropdown-submenu  dropdown-toggle">
                                        <a aria-label="Twitter" class="dropdown-item"
                                            href="https://www.taxmanager.in/efile/nri_FD.aspx">Other Income – FD
                                            Interest etc
                                        </a>
                                    </li>
                                    <li class="dropdown-submenu  dropdown-toggle">
                                        <a aria-label="Twitter" class="dropdown-item"
                                            href="https://www.taxmanager.in/efile/NRI_Equity.aspx">Capital Gains (Equity
                                            &amp; MF Sale)
                                        </a>
                                    </li>
                                    <li class="dropdown-submenu  dropdown-toggle">
                                        <a aria-label="Twitter" class="dropdown-item"
                                            href="https://www.taxmanager.in/efile/NRI_PS.aspx">Capital Gains (Property
                                            Sale)
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="nav-item dropdown blue-hover">
                                <a aria-label="Twitter" class="nav-link dropdown-toggle"
                                    href="https://www.taxmanager.in/business/index.html">Business <i
                                        class="fa fa-caret-down" aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdownMenuLink"
                                    target="_blank">
                            ...
                            <li class="nav-item dropdown blue-hover">
                                <a aria-label="Twitter" class="nav-link dropdown-toggle"
                                    href="https://www.taxmanager.in/Startups/index.html">StartUps <i
                                        class="fa fa-caret-down" aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a aria-label="Twitter" class="dropdown-item"
                                            ...
                                            your Startup</a></li>
                                    <li><a aria-label="Twitter" class="dropdown-item"
                                            href="https://www.taxmanager.in/manageyourStartup">Manage your Startup</a>
                                    </li>
                                    <li><a aria-label="Twitter" class="dropdown-item"
                    ...
                    <div class="resultsection">
                        ...
                        <div class="row">
                            <div class="searchfiled">
                                <asp:TextBox runat="server" ID="txt1" placeholder="Please Enter Employee ID"
                                    CssClass="searchinputfiled"></asp:TextBox>
                                <asp:Button runat="server" CssClass="searcbtn" ID="btnsubmit" Text="Submit"
                            ...
                            <div id="msg" runat="server" visible="false">
                                <span style="color:red;padding:20px;">
                                    <h3>Please Enter Valid Employee ID</h3>
                                </span>
                            </div>
                    ...
                    <div class="col-sm-9 p-3 row text-light ">
                        ...
                        <div class="col-lg-3 col-md-6 pt-3 myclass ">
                            <h5><a aria-label="Twitter " href="https://www.taxmanager.in/Inmedia">In
                                    The Media</a></h5>
                            <h5><a aria-label="Twitter " href="https://www.taxmanager.in/tm360/blogs/ ">Blogs</a></h5>
                        ...
                        <div class="row col-md-6 ">
                            ...
                            <div class="d-flex copyright " id="center ">
                                ...
                                <span><a aria-label="Twitter " href="# ">
                                        <img src="https://www.taxmanager.in/newsite/images/ssllogo.png "
                                            alt=" "></a></span>
                                <span><a aria-label="Twitter " href="# ">
                                        <img src="https://www.taxmanager.in/newsite/images/isologo.png "
                                            alt=" "></a></span>
                            </div>
                        </div>
