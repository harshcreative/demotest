<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxCalculator2021.aspx.cs" Inherits="TaxCalculator2021" %>
    ...
    <head>
        ...
        <title>Tax Calculator 20-21 TaxManager.in</title>

        <link rel="icon" type="image/png" href="http://www.TaxManager.in/htmlcode/images/favicon.ico" />
                    ...
                    <ul>
                        ...
                        <li><a href="#">Investments<span class="caret"></span></a>
                            <ul>
                                ...
                                <li><a href="http://www.taxmanager.in/planyourtaxsavings.html">Start Investing<span
                                            class="caret"></span></a></li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/mutualfunds/invest_mf.html"> <img
                                            src="http://www.taxmanager.in/career/images/mutul1.png"
                                            style="margin-top:-6px;"> Mutual Funds</a>
                                </li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/LifeInsurance/invest_li.html"><img
                                            src="http://www.taxmanager.in/career/images/life.png"
                                            style="margin-top:-2px;"> Life Insurance</a>
                                </li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/healthinsurance/invest_hi.html"><img
                                            src="http://www.taxmanager.in/career/images/health.png"
                                            style="margin-top:-6px;"> Health Insurance</a>
                                </li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/ppf/invest_ppf.html"><img
                                            src="http://www.taxmanager.in/career/images/public.png"
                                            style="margin-top:6px;"> Public Provident Fund</a>
                                </li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/nsc/invest_nsc.html"> <img
                                            src="http://www.taxmanager.in/career/images/national.png"
                                            style="margin-top:-6px;"> National Savings Certificates</a>
                                </li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/nps/invest_nps.html"><img
                                            src="http://www.taxmanager.in/career/images/nps.png"
                                            style="margin-top:-6px;"> NPS</a>
                                </li>
                                <li>
                                    <a href="http://www.taxmanager.in/invest/others/invest_others.html"> <img
                                            src="http://www.taxmanager.in/career/images/other.png"
                        ...
                        <li style="background-color: #1D7E33 !important;"><a style="color:#fff;"
                                href="http://www.taxmanager.in/career/index.html">We're Hiring<span
                                    class="caret"></span></a></li>
                        <li style="background-color: #337ab7!important;"><a style="color:#fff;"
                                href="http://www.taxmanager.in/Login/Login.aspx">Login / Register</a></li>
                    </ul>
                </nav>
                <!--  mobile responsive -->
                <nav class="navbar  mn">
                            ...
                            <ul class="nav navbar-nav">
                                <li class="active">
                                    <a href="../index.html"><img
                                            src="http://www.taxmanager.in/images/home.png">&nbsp;&nbsp;Home</a>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img
                                            src="http://www.taxmanager.in/images/file.png">&nbsp;&nbsp;Tax-eFiling
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img
                                            src="http://www.taxmanager.in/images/manager1.png">&nbsp;&nbsp;Tax
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img
                                            src="http://www.taxmanager.in/images/earnings.png">&nbsp;&nbsp;Investment<span
                                            class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="http://www.taxmanager.in/planyourtaxsavings.html">Plan You Tax
                                                Savings</a></li>
                                        <li><a href="http://www.taxmanager.in/planyourtaxsavings.html">Start
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img
                                            src="http://www.taxmanager.in/images/fc.png">&nbsp;&nbsp;NRIs
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="http://www.taxmanager.in/nri_returns.html">NRI Tax Returns</a></li>
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img
                                            src="http://www.taxmanager.in/images/group.png">&nbsp;&nbsp;Business
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="http://www.taxmanager.in/KnowledgeBank/index.html"><img
                                            src="http://www.taxmanager.in/images/manager1.png">&nbsp;&nbsp;Knowledge
                                        Bank<span class="caret"></span></a>
                                </li>
                                <li style="background-color: #1D7E33 !important;">
                                    <a href="http://www.taxmanager.in/career/index.html"
                                ...
                                <li style="background-color: #337ab7 !important;">
                                    <a href="../Login/login.html" style="color:#fff;"><img
                                            src="http://www.taxmanager.in/images/sign.png">&nbsp;&nbsp;Login /
                                        Register</a>
                                </li>
                            </ul>
                ...
                <div class="dropup">
                    <div class="row">
                        <div class="hero-banner__heading">
                            ...
                            <h1 style="color:#fff">Tax <span style="color:#fff">e-Filing</span></h1>
                        </div>
                        ...
                        <div class="col-md-4 " id="yourself">
                            <div class="hero-banner__heading__file-yourself">
                                ...
                                <p style="float: left;"> <a
                                        href="http://www.taxmanager.in/UserAc/Register.aspx?From=TaxM&amp;Product=Basic">File
                                        Yourself</a>

                                </p>
                                <p class="back2" style="margin-top: 0px;float: right;margin-left: 20px;"> <a
                                        href="http://www.taxmanager.in/income-tax-filing/">CA Assisted e-Filing</a></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3 col-lg-3 ">
                                    <div class="footer__services-list">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="http://www.taxmanager.in/Individuals-Plan.html">eFile Tax
                                                    Returns</a></li>
                                            <li><a href="http://www.taxmanager.in/tap.html">Tax Assessment Protect</a>
                                            </li>
                                            <li><a href="http://www.taxmanager.in/mytaxquery.html">Tax Consulting</a>
                                            </li>
                                            <li><a href="http://www.taxmanager.in/home.html">Tax Refund</a></li>
                                            <li><a href="http://www.taxmanager.in/itr_rectification.html">Tax
                                                    Rectification</a></li>
                                            <li><a href="http://www.taxmanager.in/home.html">Tax Intimations</a></li>
                                            <li><a href="http://www.taxmanager.in/home.html">ITR V Request</a></li>
                                            <li><a href="http://www.taxmanager.in/home.html">26 AS (Tax Credit)</a></li>
                                            <li><a href="http://www.taxmanager.in/asp.html">Tax Planning</a></li>
                                            <li><a href="http://www.taxmanager.in/ctcoptimiser.html">CTC Optimizer</a>
                                            </li>
                                            <li><a href="http://www.taxmanager.in/panapply.html">PAN/ TAN Request</a>
                                            </li>
                                            <li><a href="http://www.taxmanager.in/asp.html">Annual Subscription
                                                    Package</a></li>
                                            <li><a href="http://www.taxmanager.in/digital_signature.html">Digital
                                                    Signature</a></li>
                                ...
                                <div class="col-md-3 col-sm-3 col-lg-3">
                                    ...
                                    <div class="footer__services-list">
                                        <h4>I am...</h4>
                                        <ul>
                                            <li> <a href="http://www.taxmanager.in/tms_sc.html">Salaried Individual</a>
                                            </li>
                                            <li> <a href="http://www.taxmanager.in/tms_hni.html">High Net Worth
                                                    Individual</a></li>
                                            <li> <a
                                                    href="http://www.taxmanager.in/tms_business_class.html">Proprietor</a>
                                            </li>
                                            <li> <a href="http://www.taxmanager.in/tms_nri.html">Non Resident Indian</a>
                                            </li>
                                            <li> <a href="http://www.taxmanager.in/TaxManager-eFilingGateway.html">CA/
                                                    Tax Professional</a></li>
                                            <li> <a href="http://www.taxmanager.in/Corporate-Plan.html">Corporate
                                                    Company</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <ul class="footer-links">
                                        ...
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/About_Us.html">About Us</a></li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/Privacy-Policy.html">Privacy Policy</a>
                                        </li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/Inmedia.html">In the Media</a></li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/Legal_Disclaimer.html">Legal
                                                Disclaimer</a></li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/FAQs.html">FAQs</a></li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/Terms_Conditions.html">Terms &amp;
                                                Conditions</a></li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/home.html">Site Map</a></li>
                                        <li><span>|</span></li>
                                        <li><a href="http://www.taxmanager.in/home.html">Security</a></li>
                                    </ul>
