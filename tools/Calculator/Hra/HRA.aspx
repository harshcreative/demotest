<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRA.aspx.cs" Inherits="HRA" %>
    ...
    <head>
        ...
        <script type="text/javascript" src="complete-compiled.js"></script>
        <style type="text/css">
            .auto-style6 {
                position: absolute;
                top: 332px;
    ...
    <body>
        <!-- Popup To Services -->
        <div class="indiserboxpop">
            <div class="custom-model-inner">
                <div class="closebnt">×</div>
                <div class="custom-model-wrap">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-lg-4">
                                <div class="boximgcontain">
                                    <div class="imgbox">
                                        <img src="/tm360/images/banner/startup.png" alt="">
                                    </div>
                                    <div class="textconarbn">
                                        <h4>Startup</h4>
                                        <ul>
                                        ...
                                        <a href="/tm360/startup/index" class="btnares">Click here</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4">
                                <div class="boximgcontain">
                                    <div class="imgbox">
                                        <img src="/tm360/images/banner/business.png" alt="">
                                    </div>
                                    <div class="textconarbn">
                                        <h4>Business</h4>
                                        <ul>
                                            ...
                                            <li><a href="#">Annual Compliances</a></li>
                                            <li><a href="#">Company Registration</a></li>
                                        </ul>
                                        <a href="/tm360/business/index" class="btnares">Click here</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4">
                                <div class="boximgcontain">
                                    <div class="imgbox">
                                        <img src="/tm360/images/banner/individuals.png" alt="">
                                    </div>
                                    <div class="textconarbn">
                                        <h4>Individuals</h4>
                                        <ul>
                                        ...
                                        <a href="/tm360/individuals/index" class="btnares">Click here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Popup Contac Form -->
        <div class="custom-model-main popupsecautorenew">
            <div class="custom-model-inner popupsection">
                ...
                <div class="custom-model-wrap">
                    <div class="pop-up-content-wrap">
                        ...
                        <div class="contac-us">
                            <div class="quick-box">
                                <h6>Let’s connect</h6>
                                <form method="post" id="contactFormTop">
                                    <div class="fromzon">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="uName" id="uName" placeholder="Enter Your Name" required="">
                                            <span class="error"></span>
                                        </div>
                                        <div class="form-group">
                                            <input type="eMail" class="form-control" name="ueMail" id="ueMail" placeholder="Enter Your eMail" required="">
                                            <span class="error"></span>
                                        </div>
                                        <div class="form-group">
                                            <input type="number" class="form-control mobile_codewith_flage" name="uPhoneNumber" id="ufPhoneNumber" placeholder="ENTER MOBILE NUMBER">
                                            <span class="error"></span>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" name="uCompany" id="uCompany" placeholder="Select Services">
                                                <option value="">Choose one of the following</option>
                                                <option value="Tax Calculation23-24">Tax Calculations FY 23-24</option>
                                                <option value="Tax Treatment on Asset Sale">Tax Treatment on Asset Sale
                                                </option>
                                                <option value="CA Certificates for Foreign Remittances">CA Certificates
                                                    for
                                                    Foreign Remittances</option>
                                                <option value="Tax Advisiory">Tax Advisiory</option>
                                                <option value="Tax Return EFiling">Tax Return EFiling</option>
                                                <option value="Tax Notice">Tax Notice</option>
                                                <option value="Tax Rectification">Tax Rectification</option>
                                                <option value="Cash Income and Deposit">Cash Income and Deposit</option>
                                                <option value="Tax Audit">Tax Audit</option>
                                                <option value="Tax Assessment">Tax Assessment</option>
                                                <option value="Business &amp; Consultancy Income">Business &amp;
                                                    Consultancy
                                                    Income</option>
                                                <option value="Tax Advisioty-Capital Gains">Tax Advisioty-Capital Gains
                                                </option>
                                                <option value="Annual Subscription Package">Annual Subscription Package
                                                </option>
                                                <option value="Others">Others</option>
                                            </select>
                                        </div>
                                        <div class="form-group fullsection">
                                            <label for="Messae">Message*</label>
                                            <textarea aria-label="Message" name="uMessage" id="uMessage" class="form-control" rows="3"></textarea>
                                        </div>
                                        <div class="btnsection">
                                            <button type="button" class="submit-btn" value="Submit" id="bottomfrom" name="ubottomfrom" aria-label="bottomfrom">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/tm360/tools/Calculator/emi-calculator.html">
                                                <span>
                                                    <img class="lazyload" alt="Tax Calculator | TaxManager.in"
                                                        src="/tm360/Images/icon/tools/emi.png">
                                                </span> EMI Calculator
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/tm360/tools/calendar.html">
                                                <span>
                                                    <img class="lazyload" alt="HRA Calculator | TaxManager.in"
                                                        src="/tm360/Images/icon/tools/compliances.png">
                                        ...
                                        <li>
                                            <a href="http://gst.taxmanager.in/">
                                                <span>
                                                    <img class="lazyload" alt="Tax Calculator | TaxManager.in"
                                                        src="/tm360/Images/icon/tools/gst.png">
                                        ...
                                        <li>
                                            <a href="/tm360/tools/calculator/hsn-code/">
                                                <span>
                                                    <img class="lazyload" alt="Tax Calculator | TaxManager.in"
                                                        src="/tm360/Images/icon/tools/gst-hsn.png">
                                                </span> GST HSN Code
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/tm360/tools/tax-calculator.html">
                                                <span>
                                                    <img class="lazyload" alt="Tax Calculator | TaxManager.in"
                                                        src="/tm360/Images/icon/tools/old-vs-new.png">
        ...
        <div class="formsectionareasediv">
            <table align="center">
                <tr>
                    <td width="782" height="45" align="center">
                        <b>
                ...
                <form id="form1" runat="server">
                    <table border="0" cellspacing="4" cellpadding="3" bgcolor="#F0F0F0" style="height: 45px; width: 714px;">
                        <tr>
                            ...
                            <input type="hidden" id="HT12" />
                        </tr>
                    </table>
                    <table id="tblmain" style="display: block; margin-top: 0px; background-color: #F0F0F0; width: 714px; height: 458px;" cellpadding="4px" cellspacing="4px">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;" class="auto-style9">
                                <font face="Verdana" size="2">
                                    <b>Annual Basic Salary</b>
                            </td>
                            <td class="auto-style62">
                                <font face="Verdana">
                                    <input type="text" name="T1" id="T1" size="20" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46' onchange="addCommasT1()" style="border-color: lightgrey; font-weight: 700; font-size: 9pt; width: 188px; text-align: right; padding-right: 5px; height: 27px; margin-left: 14px;">
                                </font>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;" class="auto-style14">
                                <font face="Verdana" size="2">
                                    <strong>Annual Dearness Allowance (DA)*</strong>
                                </font>
                                <br>
                                <span style="color: Gray">
                                    <font face="Verdana" size="2">(Enter only if DA is&nbsp; considered while
                                        calculating retirement benefits)</font>
                                </span>
                            </td>
                            <td class="auto-style15">
                                <div>
                                    <input id="T2" name="T2" size="20" onkeypress='return event.charCode >= 48 && event.charCode 
                                        <= 57 || event.charCode == 46' style="border-color: lightgrey; font-weight: 700; font-size: 9pt; height: 25px; width: 188px; text-align: right; padding-right: 5px; margin-top: 0px; margin-left: 14px;" onchange="addCommasT2()"
                                        type="text" />
                                    <input type="hidden" id="HT2" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="30px" style="text-align: left">
                                <font face="Verdana" size="2">
                                    <strong>Annual commission</strong>
                                </font>
                                <span class="aestrix">*</span>
                                <span class="auto-style21" style="color: Gray;">
                                    <font face="Verdana" size="2">(Enter only if commission is % of sales) </font>
                                </span>
                            </td>
                            <td height="30px" style="text-align: left" class="auto-style8">
                                <input id="T3" name="T6" size="20" onkeypress='return event.charCode >= 48 && event.charCode 
                                        <= 57 || event.charCode == 46' onchange="addCommasT3()" style="border-color: lightgrey; font-weight: 700; text-align: right; padding-right: 5px; font-size: 9pt; height: 25px; width: 188px; margin-left: 14px; margin-top: 0px;"
                                    type="text" />
                                <input type="hidden" id="HT3" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="30px" style="text-align: left" class="auto-style10">
                                <font face="Verdana" size="2">
                                    <strong>Annual HRA</strong>
                                </font>
                                <span class="aestrix">*</span>
                            </td>
                            <td height="30px" style="text-align: left">
                                <div>
                                    <input id="T4" name="T4" size="20" onkeypress='return event.charCode >= 48 && event.charCode 
                                                <= 57 || event.charCode != 46' onchange="addCommasT4()" style="border-color: lightgrey; font-weight: 700; font-size: 9pt; height: 25px; width: 188px; text-align: right; padding-right: 5px; margin-left: 17px; margin-top: 13px;"
                                        type="text" />
                                    <input type="hidden" id="HT4" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" class="auto-style23">
                                <strong>
                                    <font face="Verdana" size="2" style="text-align: left">
                                        <strong>Annual Rent Payable</strong>
                                </font>
                                </strong>
                            </td>
                            <td valign="middle" class="auto-style23">
                                <div>
                                    <input id="T5" name="T5" size="20" onkeypress='return event.charCode >= 48 && event.charCode 
                                                            <= 57 || event.charCode == 46' onchange="addCommasT5()" style="border-color: lightgrey; font-weight: 700; font-size: 9pt; height: 24px; width: 188px; margin-top: 15px; text-align: right; padding-right: 5px; margin-left: 14px;"
                                        type="text" />
                                    <br />
                                    <input type="hidden" id="HT5" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <div style="margin-left: 668px; margin-top: 0px"></div>
            --%>
                            ...
                            <table id="tblResult" style="display: none; background-color: #F0F0F0; width: 714px; height: 499px;" align="center" cellpadding="4px" cellspacing="4px">
                                ...
                                <font face="Verdana" size="2" colspan="20px">TaxFree</font>
                                    ...
                                    <td class="auto-style27">
                                        <div class="r_deduction">
                                            <input id="Text16" name="T2" size="20" readonly="true" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46' <%--onclick="ConvertNumber16(this.value)" --%> style="background-color:
                                            transparent; border: none; font-weight: 700; font-size: 9pt; height: 25px; width: 188px; text-align: right; padding-right: 5px;" type="text" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <font face="Verdana" size="2">Taxable</font>
                                    ...
                                    <td class="auto-style24">
                                        <div class="r_deduction">
                                            <input id="Text17" name="T3" size="20" readonly="true" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 46' <%--onchange="ConvertNumber17(this.value)" --%> style="background-color:
                                            transparent; border: none; font-weight: 700; text-align: right; padding-right: 5px; font-size: 9pt; height: 25px; width: 188px;" type="text" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="40" class="auto-style37" colspan="3">
                                        <strong>
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="auto-style5">
                                                                        <a href="http://www.TaxManager.in/login/login.aspx">
                                                                            <img border="0" height="75" src="http://www.TaxManager.in/images/icon-01.png" width="75" />
                                                                        </a>
                                                                    </td>
                                                                    ...
                                                                    <td align="center" width="16%">
                                                                        <a href="http://www.TaxManager.in/efile/taxnoticeservice.aspx?Item=1">
                                                                            <img border="0" height="75" src="http://www.TaxManager.in/images/icon-03.png" width="75" />
                                                                        </a>
                                                                    </td>
                                                                    <td align="center" width="16%">
                                                                        <a href="http://www.TaxManager.in/efile/aspsubscribe.aspx?Item=1">
                                                                            <img border="0" height="75" src="http://www.TaxManager.in/images/icon-05.png" width="75" />
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" class="auto-style5">
                                                                        <p align="center" style="line-height: 150%; margin-top: 0; margin-bottom: 0">
                                                                            <font color="#000080" face="Verdana" style="font-size: 8pt">
                                                                                <span style="text-decoration: none">
                                                                        <font color="#000080">
                                                                            <a class="auto-style13"
                                                                                href="http://www.TaxManager.in/login/login.aspx">
                                                                                <span class="auto-style12">Prepare
                                                                        ...
                                                                        <p align="center" style="line-height: 150%; margin-top: 0; margin-bottom: 0">
                                                                            <font color="#000080" face="Verdana" style="font-size: 8pt">
                                                                                <a class="auto-style13" href="#Book_Mark">
                                                                                    <span class="auto-style12">Do it yourself</span>
                                                                                </a>
                                                                            </font>
                                                                        </p>
                                                                    </td>
                                                                    <td align="center" class="auto-style12" width="16%">
                                                                        <p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
                                                                            <font color="#000080" face="Verdana" style="font-size: 8pt">
                                                                                <a class="auto-style13" href="http://www.TaxManager.in/efile/hdfcefile.aspx">
                                                                    ...
                                                                    <td align="center" width="16%">
                                                                        <p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
                                                                            <font color="#000080" face="Verdana" style="font-size: 8pt">
                                                                                <a class="auto-style13" href="http://www.TaxManager.in/efile/taxnoticeservice.aspx?Item=1">
                                                                    ...
                                                                    <td align="center" width="16%">
                                                                        <p style="line-height: 150%; margin-top: 0; margin-bottom: 0">
                                                                            <font color="#000080" face="Verdana" style="font-size: 8pt">
                                                                                <a class="auto-style13" href="http://www.TaxManager.in/efile/aspsubscribe.aspx">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="footer_menu_Sec">
                                ...
                                <ul class="catifications">
                                    <li>
                                        <a href="/tm360/certified.html"><img src="/tm360/Images/RISING-ADVISORY-SERVICES-PRIVATE-LIMITED-ISO-9001.webp" alt="RISING ADVISORY SERVICES PRIVATE LIMITED ISO 9001"></a>
                                    </li>
                                    <li>
                                        <a href="https://www.ssl.com/faqs/faq-what-is-ssl/" target="_blank"><img src="/tm360/Images/ssl-1.webp" alt="RISING ADVISORY SERVICES PRIVATE LIMITED ISO 27001"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row secondfooter">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <ul class="social-mediased">
                                    ...
                                    <li><a target="_blank" href="https://www.facebook.com/efileitr" aria-label="Facebook taxmanager"><span><i
                                                class="fab fa-facebook-f"></i></span></a>
                                    </li>
                                    <li><a target="_blank" href="https://www.instagram.com/taxmanagerofficial/" aria-label="Instagram taxmanager"><span><i
                                                class="fa-brands fa-instagram"></i></span></a>
                                    </li>
                                    <li><a target="_blank" href="https://twitter.com/taxmanagerindia" aria-label="Twitter taxmanager"><span><i
                                                class="fa-brands fa-x-twitter"></i></span></a>
                                    </li>
                                    <li><a target="_blank" href="https://in.linkedin.com/company/taxmanager-in" aria-label="Linkedin Taxmanager"><span><i
            ...
            <div class="fixed">
                <ul>
                    <li>
                        <a target="_blank" href="https://api.whatsapp.com/send?phone=919625445516&amp;text=Hi I am Looking for Tax Expert Assistance"><i
            ...
            <!-- Gallery -->
            <script src="/tm360/js/jquery.magnific-popup.min.js"></script>
            <!-- carousel -->
            ...
            <script src="/tm360/js/snow.js"></script>
            <script src="/tm360/js/plane.js"></script>
            <!-- Slider Code -->
            <script src="/tm360/js/owl.slider.js"></script>
            <!-- form section  -->
            <script src="/tm360/js/form.js"></script>
