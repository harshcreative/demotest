<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MTaxCalculator.aspx.cs" Inherits="MTaxCalculator" %>
    ...
    <head>
        ...
        <title>Income Tax Calculator Financial</title>
        ...
        <script type="text/javascript">
            ...
            function fill() {
                ...
                if (txt1.toString().length == 6) {
                    document.getElementById("T3").value = document.getElementById("T3").value.toString().substring(1, 2).replace("", ",");
                }
            ...
            function fillanother() {
                ...
                //alert(document.getElementById("T8").value);
        ...
        <script type="text/javascript">
            ...
            function hideview1() {
                ...
                if (c1.value == "") {
                    ...
                    alert("Required Field :Mobile ");
                    return false;
                }
                //var c1 = document.getElementById("emailid");
                ////var l1 = document.getElementById("VT1");

                //if (c1.value == "") {

                //    alert("Required Field :EmailID ");
                //    return false;
                //}
            ...
            function hideview2() {
                ...
                if (c1.value == "") {
                    alert("Required Field :Income from Salary");
                    return false;
                }
                var c1 = document.getElementById("T4");
                if (c1.value == "") {
                    alert("Required Field :Income from House Property");
                    return false;
                }
                var c1 = document.getElementById("T5");
                if (c1.value == "") {
                    alert("Required Field :Income from Business and Profession");
                    return false;
                }

                var c1 = document.getElementById("T6");
                if (c1.value == "") {
                    alert("Required Field : Income from Sale of Assets");
                    return false;
                }

                var c1 = document.getElementById("T7");
                if (c1.value == "") {
                    alert("Required Field :Income from Bank Interest and Others");
                    return false;
                }
        ...
        <script type="text/javascript">
            ...
            function CalTax(T27, age) {
                ...
                //alert(functionReturnValue + " functionReturnValue2");
                //document.getElementById("T13").value = functionReturnValue;
    ...
    <body{width:100%;margin:auto;min-width:200px;max-width:2000px,align:center}>
        ...
        <form id="form1" runat="server">
            ...
            <div align="center">
                <table border="0" width="100%" cellpadding="2">
                    <tr>
                        <td width="70%" align="center" height="45"><b>
                                <font face="Verdana" color="#000080" style="font-size: 11pt">&nbsp;Income Tax
                                    Calculator Financial Year 2016-17</font>
                            </b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="70%" align="center">
                            <table border="0" width="100%" cellpadding="2" bgcolor="#F0F0F0">
                                <div>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <font color="#FFFFFF" face="Verdana" size="4"
                                                            ...
                                                            <input type="text" id="Text1" value="Personal Details"
                                                                readonly="readonly"
                                                                style="border-style: none; border-color: inherit; border-width: medium; margin-left:462px; background-color:transparent; color:#CCCCCC; font-weight:700; font-size:large;"
                                                                onclick="view1()" />
                                                        </font>
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <table border="0" width="100%" cellpadding="2" id="divone">
                                            <tr>
                                                <td height="0">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td height="40" class="auto-style3">
                                                ...
                                                <td height="40" class="auto-style3">
                                                    <font face="Verdana">
                                                        <input type="text" name="T1" id="T1" size="20"
                                                            style="border-color:lightgrey; font-weight: 700;">
                                                    </font>
                                                </td>
                                            <tr>
                                                <td height="40" class="auto-style3">
                                            ...
                                            <tr>
                                                <td height="40" class="auto-style3">
                                                    <font face="Verdana" size="2">
                                                        <input type="radio" name="sex" id="sex" value="m" size="2">Male
                                            ...
                                            <tr>
                                                <td height="40" class="auto-style3">
                                                    <font face="Verdana" size="2" style="border-color:lightgrey;">
                                                        <strong>Mobile</strong></font>
                                                </td>
                                            <tr>
                                                <td height="40" class="auto-style3">&nbsp;<font face="Verdana"><input
                                                            type="text" name="T2" id="T2" maxlength="10"
                                        ...
                                        <p align="center"><b>
                                                <font face="Verdana" color="#FF9900">--%>
                                                    <input type="button" value="Next" id="btnnext"
                                                        onchange="validations()" onclick="view2();"
            ...
            <tr>
                <div id="divinc" style="display:none;">
                        ...
                        <table border="0" width="100%" cellspacing="4" cellpadding="4">
                            <tr>
                                <td class="auto-style2">
                                    <font color="#FFFFFF" face="Verdana" size="4"
                                        style="font-weight: 700; color: #CCCCCC">
                                        <input type="text" id="Text2" value="Income Details" readonly="readonly"
                                            style="border-style: none; border-color: inherit;
 border-width: medium; margin-left:484px; background-color:transparent; color:#CCCCCC; font-weight:700; font-size:large;" onclick="view2()" />
                                    </font>
                                </td>
                            </tr>
                        </table>
                ...
                <td height="40">
                    <%--<div id="div5" style="display:none;" --%>
                        <table border="0" width="100%" cellpadding="2" id="div2" style="display:none;">
                            <tr>
                                <td width="40%" height="40" class="auto-style3" style="width: 98%">
                                    <font face="Verdana" size="2"><strong>Income from Salary</strong></font>
                                </td>
                            </tr>
                            <tr>
                                <td height="40" class="auto-style3">
                            ...
                            <tr>
                                <td height="40" class="auto-style3">
                                    <font face="Verdana" size="2"><strong>Income
                            ...
                            <tr>
                                <td height="40" class="auto-style3">
                                    <font face="Verdana" size="2" value="0"><strong>Income
                            ...
                            <tr>
                                <td height="40" class="auto-style3">&nbsp;</td>
                            </tr>
                            <tr>
                                <td height="40" class="auto-style3">
                            ...
                            <tr>
                                <td height="40" class="auto-style3">
                                    <font face="Verdana" size="4">
                                        <input type="text" name="T8" size="20" readonly="readonly" id="T8"
                                            onchange="fill()"
                            ...
                            <tr>
                                <td bgcolor="#003399">
                                    <p align="center"><b>--%>
                                            <%--<font face="Verdana" color="#FF9900">--%>
                                                <input type="button" value="Next" id="Button1" onclick="view3();"
                                                    style="background-color:green;color:white ;height:25px;width:80px;border:none;" />
                                                <%--< /font></b>
                                </td>
                            </tr>
                    ...
                    <tr>
                        <td height="55" bgcolor="#666666" style="font-weight: 700">
                            <table border="0" width="100%" cellspacing="4" cellpadding="4">
                                <tr>
                                    <td class="auto-style2">
                                        <input type="text" id="Text3" value="Deductions" readonly="readonly"
                                            style="border-style: none; border-color: inherit;
 border-width: medium; margin-left:484px; background-color:transparent; color:#CCCCCC; font-weight:700; font-size:large;" onclick="view3()" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td height="40">
                            <table border="0" width="100%" cellpadding="2" id="div4" style="display:none;">
                                <tr>
                                    <td width="40%" height="40" class="auto-style3" style="width: 98%">
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <td width="40%" height="40" class="auto-style3" style="width: 98%">
                                        <font face="Verdana" size="2"><strong>Total Investments done
                                ...
                                <tr>
                                    <td width="40%" height="40" class="auto-style3" style="width: 98%">
                                        <font face="Verdana">
                                            <input type="text" name="T19" id="T19" onchange="fillanother()" value="0"
                                                size="20" style="text-align:right; font-weight: 700;"
                                                onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana" size="2">
                                            <strong>Interest benefit from house property</strong>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana">
                                            <input type="text" name="T28" id="T28" onchange="fillanother()" size="20"
                                                value="0" style="text-align:right; font-weight: 700;"
                                                onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana" size="2">
                                            <strong>Expenditures u/s 80D and others like medical
                                                insurance</strong>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana">
                                            <input type="text" name="T21" id="T21" onchange="fillanother()" value="0"
                                                size="20" style="text-align:right; font-weight: 700;"
                                                onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </font>
                                    </td>
                                ...
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana" size="2" value="0"><strong>Total
                                                Deductions</strong></font>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="40" class="auto-style3">
                                ...
                                <tr>
                                    ...
                                    <td height="40" width="40%" class="auto-style3" style="width: 98%">
                                        <font face="Verdana" size="2">
                                            <br /> <br />
                                ...
                                <tr>
                                    ...
                                    <td height="40" width="40%" class="auto-style3" rowspan="2" style="width: 98%">
                                        <font face="Verdana">
                                            <input type="text" name="T27" size="20" id="T27" onchange="netfill()"
                                                style="background-color:#F0F0F0;border:none; font-weight: 700; font-size: 10pt;text-align:right;"
                                                font-weight: 700;" value="0" readonly="readonly">
                                        </font><%--<input type="text" id="T31" name="T31" onchange="total()" value="0"
                                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' />--%>
                                        </font>
                                    </td>
                                <tr>
                                        ...
                                        <td>
                                            <%--<p align="center"><b>
                                                    <font face="Verdana" color="#FF9900">--%>
                                                        ...
                                                        <input type="text" readonly="readonly" border="0" id="txtlbl"
                    ...
                    <tr>
                        <td height="55" bgcolor="#666666">
                            <table border="0" width="100%" cellspacing="4" cellpadding="4">
                                <tr>
                                    <td class="auto-style2">
                                        <input type="text" id="Text4" value="Tax Computations" readonly="readonly"
                                            style="border-style: none; border-color: inherit;
 border-width: medium; margin-left:484px; background-color:transparent; color:#CCCCCC; font-weight:700; font-size:large;"
                                            onclick="view4()" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td height="40">
                            <table border="0" width="100%" cellpadding="2" id="div55" style="display:none;">
                                <tr>
                                    <td width="40%" height="40" class="auto-style3" style="width: 98%">
                                        <font face="Verdana" size="2"><strong>Basic Tax on Total
                                                Income</strong></font>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="40%" height="40" class="auto-style3" style="width: 98%">
                                        <font face="Verdana">
                                            <input type="text" name="T13" id="T13" size="20" value="0"
                                                ...
                                                style="background-color:#F0F0F0;border:none; font-weight: 700; font-size: 10pt;text-align:right;"
                                                font-weight: 700;" readonly="readonly"
                                                onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </font>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana">
                                            <input type="text" name="T14" id="T14" size="20" onchange="otherchange()"
                                                value="0"
                                                style="background-color:#F0F0F0;border:none; font-weight: 700; font-size: 10pt;text-align:right;"
                                                font-weight: 700;" readonly="readonly"
                                                onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                ...
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana" size="2">
                                            <strong>Education Cess @ 3%</strong>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="40" class="auto-style3">
                                        <font face="Verdana">
                                            <input type="text" name="T17" id="T17" size="20" value="0"
                                                style="background-color:#F0F0F0;border:none; font-weight: 700; font-size: 10pt;text-align:right;"
                                                font-weight: 700;" readonly="readonly"
                                                onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                        </font>
