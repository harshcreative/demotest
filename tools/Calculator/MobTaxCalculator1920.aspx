<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxCalculator.aspx.cs" Inherits="TaxCalculator" %>
    ...
    <head>
        ...
        <%-- <script type="text/javascript">
            ...
            if (document.getElementById("T27").value < 0) document.getElementById("T27").value=0; } function netfill() {
                if (document.getElementById("T27").value==0) { alert("One of the Income Source is required, Income
                cannot be NIL"); document.getElementById("div4").style.display="none" ; return false; } return true; }
                </script>
                ...
                <script type="text/javascript">
                    ...
                    function hideview2() {
                        ...
                        if (document.getElementById("T3").value == "0" && document.getElementById("T4").value == "0" && document.getElementById("T5").value == "0" && document.getElementById("T6").value == "0" && document.getElementById("T7").value == "0") {
                            return false;
                                    ...
                                    <tr>
                                        <td>
                                            <p align="center"><img border="0"
                                                    ...
                                                    height="60" align="center"><a href="http://www.TaxManager.in"></a>
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <td width="70%" height="45">
                            <font face="Verdana" color="#000080" style="text-align: center">
                                <p align="center" class="auto-style7">&nbsp;Income Tax
                                    Calculator Financial Year 2019-20</p>
                            </font>
                        </td>
                    </tr>
                    <tr>
