...
public partial class PrintTaxDetail : System.Web.UI.Page
{
    ...
    {
        conn.Open();
        SqlCommand cmd = new SqlCommand("Select * from tbl_taxCal order by id desc", conn);
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
      ...
      string updateqry =  "update tbl_taxCal set name= '" + txtName.Text + "', sex='" +  txtsex.Text + "',mobile=" + txtmobile.Text + ", email='" + txtemail.Text + "',age='" + 
          ...
          ", NTI=" + txtNTI.Text + ", BasTax= " + txtBasTax.Text + ", SC=" + txtSC.Text + ", EC= " + txtEC.Text + ", tottax=" + txtTotTax.Text + " ,service='" + txtService.Text + "', IPAddress = " + txtIPAddress.Text
