...
public partial class TaxCalculator : Page
{
    ...
    public static string Process(string fields)
    {
        ...
        scmd.CommandText = "insert into tbl_TaxCal(Name,Sex,Mobile,eMail, Age, Salary, HP, BP,CG,OtherSrc,GTI,Ded80C,IntHP,Ded80Others,TotDed,NTI,BasTax,SC,EC,TotTax,DateEntry) values('" + fields + ",getdate())";
    ...
    public static string UpdateData(string fields)
    {
        if (fields != "")
        {
            ...
            string query = "update tbl_TaxCal set Name='" + fieldparts[0] + " ,Sex = " + fieldparts[1] + " ,Mobile = " + fieldparts[2] + ",eMail= " + fieldparts[3] + ", Age = " + fieldparts[4] + ", Salary = " + fieldparts[5] + ", HP = " + fieldparts[6] + ", BP=" + fieldparts[7] + ",CG = " + fieldparts[8]
                ...
                + ",TotDed=" + fieldparts[14] + ",NTI = " + fieldparts[15] + ",BasTax = " + fieldparts[16] + ",SC = " + fieldparts[17] + ",EC = " + fieldparts[18] + ",TotTax = " + fieldparts[19] + " , DateEntry = getdate() " 
