<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxCalculator.aspx.cs" Inherits="TaxCalculator" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            <!-
              if (screen.width <= 500) {
                  window.location = "http://www.TaxManager.in/Calculator/MobTaxCalculator1718.aspx";
              }
              //-->
        </script>
                                            ...
                                            <p align="center"><b>
                                                    <font face="Verdana" size="2">Tax Calculator &gt;&gt;
                                                        ...
                                                        <a href="http://www.taxmanager.in/calculator/hra.aspx">HRA
                                                            Calculator</a> || <a
                                                            href="http://www.taxmanager.in/calculator/taxcalculator.aspx">Income
                                                            Tax Calculator FY 16-17</a>
                                                    </font>
                                                </b>
                                        </td>
                                    </tr>
