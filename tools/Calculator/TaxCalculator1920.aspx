<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxCalculator.aspx.cs" Inherits="TaxCalculator" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            <!-
              if (screen.width <= 500) {
                  window.location = "http://www.TaxManager.in/Calculator/MobTaxCalculator1920.aspx";
              }
              //-->
        </script>
                                            ...
                                            <p align="center"><b>
                                                    <font face="Verdana" size="2">Tax Calculator &gt;&gt;
                                                        ...
                                                        <a href="http://www.taxmanager.in/calculator/hra.aspx">HRA
                                                            Calculator</a> || <a
                                                            href="http://www.taxmanager.in/calculator/taxcalculator1819.aspx">Income
                                                            Tax Calculator FY 18-19</a>
                                                    </font>
                                                </b>
                                        </td>
                                    </tr>
                                                ...
                                                <td>
                                                    <font color="#FFFFFF" face="Verdana" size="4"
                                                        ...
                                                        <input type="text" id="t1" value="Personal Details"
                                                            readonly="readonly"
                                                            style="border-style: none; border-color: inherit; border-width: medium; background-color:transparent; color:#CCCCCC; font-weight:700; font-size:large; width: 201px;"
                                                            onclick="view1()" />
                                                    </font>
                                                </td>
                                            </tr>
